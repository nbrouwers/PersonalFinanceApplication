...
const createSQLiteSchema = (): void => {
  ...
  db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS accounts (id INTEGER PRIMARY KEY, user_id INTEGER NOT NULL, name TEXT NOT NULL, iban TEXT, type TEXT NOT NULL, balance REAL DEFAULT 0, currency TEXT DEFAULT 'EUR', is_active INTEGER DEFAULT 1, created_at DATETIME DEFAULT CURRENT_TIMESTAMP, updated_at DATETIME DEFAULT CURRENT_TIMESTAMP);
